...
class UserModel
{
    ...
    {
        $sql = "SELECT id, first_name, last_name, email, phone, password, role, created_at, updated_at FROM User ORDER BY last_name, first_name";
    ...
    {
        $sql = "SELECT id, first_name, last_name, email, phone, password, role, created_at, updated_at FROM User WHERE id = :id";
        $stmt = $this->db->prepare($sql);
    ...
    {
        $sql = "INSERT INTO User (first_name, last_name, email, phone, password, role) 
    ...
    {
        $sql = "UPDATE User SET password = :password, updated_at = CURRENT_TIMESTAMP WHERE id = :id";
        $stmt = $this->db->prepare($sql);
